        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertRefPrefix = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TraineePublicId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorAvailability", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorAvailability_Instructors_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertRefNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TraineeCertifications_Trainees_TraineeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assessments_Instructors_RecordedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assessments_RecordedById",
                table: "Assessments",
                column: "RecordedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSessions_ClassroomId_StartDateTime",
                table: "CourseSessions",
                columns: new[] { "ClassroomId", "StartDateTime" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSessions_InstructorId_StartDateTime",
                table: "CourseSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainees_TraineePublicId",
                table: "Trainees",
                column: "TraineePublicId",
                unique: true);
